...
const ProductCard = ({ product }: ProductCardProps) => {
    ...
    return (
        <div className='col-span-1 cursor-pointer border-[1px] border-slate-200 bg-slate-200 rounded-md p-2 shadow-md transition hover:scale-105 text-center text-sm'>
